...
// certificate-form.tsx content
const certFormContent = `"use client"
...
// api/certificate/route.ts content
const certApiContent = `import { NextRequest, NextResponse } from "next/server"
...
// Write files
fs.writeFileSync('./components/certificate-form.tsx', certFormContent);
console.log('Written: components/certificate-form.tsx (' + certFormContent.length + ' bytes)');

fs.writeFileSync('./app/api/certificate/route.ts', certApiContent);
console.log('Written: app/api/certificate/route.ts (' + certApiContent.length + ' bytes)');
